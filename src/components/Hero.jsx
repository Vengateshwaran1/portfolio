      ...
      <div className="grid md:grid-cols-2 place-items-center gap-8 p-0 md:p-2">
        ...
        >
          ...
          >
            ...
            >
              <a href="https://docs.google.com/document/d/1a4Vl2eeDTXp_xJY-87Ze2YkTFnNM2YSp/edit">
                Resume
                <WiCloudDown className="mx-5" />
              </a>
            </motion.button>
            ...
            <div className="flex gap-6 flex-row text-4xl md:text-6xl text-purple-400 z-20">
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                href="https://www.linkedin.com/in/vengateshwaran-k"
              >
                <AiOutlineLinkedin />
              </motion.a>
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                href="https://www.instagram.com/vengateshwaran_"
              >
                <AiOutlineInstagram />
              </motion.a>
            </div>
        ...
        >
          ...
          <SiMongodb className="text-green-500 mx-2 animate-vibrate1" />
          <SiExpress className="text-zinc-600 mx-2 animate-vibrate2" />
          <GrDocker className="text-blue-500 mx-2 animate-vibrate1" />
        </motion.div>
