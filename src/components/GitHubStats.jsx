  ...
  return (
    <section id="github" className="relative py-32 md:py-44">
      <div className="container-x">
        ...
        <Reveal>
          <div className="glass-metallic rounded-3xl border border-white/[0.08] shadow-glass overflow-hidden">
            <div className="flex items-center justify-between gap-4 px-6 md:px-8 py-5 border-b border-white/[0.06]">
              <div>
            ...
            <div className="px-4 md:px-8 py-6 md:py-8 bg-ink-950/40">
              <div className="rounded-2xl border border-white/[0.05] bg-ink-900/50 p-4 md:p-6 overflow-x-auto">
                <img
                  src={CHART_URL}
        ...
        <Reveal delay={0.12} className="mt-8">
          <div className="glass rounded-3xl border border-white/[0.06] overflow-hidden">
            <div className="px-6 md:px-8 py-5 border-b border-white/[0.06] flex items-center gap-3">
            ...
            <ul className="divide-y divide-white/[0.05]">
              {loading &&
                Array.from({ length: 6 }).map((_, i) => (
                  <li key={i} className="px-6 md:px-8 py-4 flex gap-4 animate-pulse">
                ...
                commits.map((c) => (
                  <li key={c.id}>
                    <a
                      ...
                      rel="noopener"
                      data-cursor="hover"
                      className="group flex gap-4 px-6 md:px-8 py-4 hover:bg-white/[0.02] transition-colors"
                    >
